...
func main() {
	...
	sampleText := []byte("Confidential data requiring encryption")
	tmpFile := "sample.txt"
	...
	if err := encryptFile(tmpFile, "encrypted.bin", key); err != nil {
...
func main() {
	...
	testData := []byte("Confidential information for encryption test")
